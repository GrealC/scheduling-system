...
import { ref } from "vue";
import { selectSelfInfo, updateUserPwd, updateSelfInfo } from "../api/user.ts";
...
<template>
  <div class="staff-info">
    ...
    <h3>个人资料</h3>
    <ul>
      <li>用户名 <el-input v-model="user" placeholder="请填写你的用户名" /></li>
      <li>
        UID <el-input v-model="uid" disabled placeholder="该项不可修改" />
      </li>
      <li>性别 <el-input v-model="gender" placeholder="请填写你的性别" /></li>
      <li>职位 <el-input v-model="role" placeholder="请填写你的职位" /></li>
      <li>
        年龄
        <el-input v-model="age" maxlength="3" placeholder="请填写你的年龄" />
      </li>
      <li>
        特长 <el-input v-model="speciality" placeholder="请填写你的特长" />
      </li>
      <li>
        薪资 <el-input v-model="salary" disabled placeholder="该项不可修改" />
      </li>
      <li>邮箱 <el-input v-model="email" placeholder="请输入你的邮箱" /></li>
      <li>
        手机号
        <el-input
          v-model="phone"
